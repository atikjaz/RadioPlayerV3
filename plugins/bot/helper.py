...
© **Powered By** : 
**@MovieAndWeb_Discuss | @IMWSmusicBot** 👑
"""
...
async def start(client, message):
    ...
    reply_markup = InlineKeyboardMarkup(buttons)
    m=await message.reply_photo(photo="https://telegra.ph/file/f1dbf86548edd1d1102ea.jpg", caption=HOME_TEXT.format(message.from_user.first_name, message.from_user.id), reply_markup=reply_markup)
    await mp.delete(m)
...
async def help(client, message):
    ...
    msg['help'] = await message.reply_photo(photo="https://telegra.ph/file/f1dbf86548edd1d1102ea.jpg", caption=HELP_TEXT, reply_markup=reply_markup)
    await mp.delete(message)
